 ...
 * </ul>
 */
public class SimpleGPUScheduler extends Scheduler {

	/** Scheduler-wide logger */
	private static final Logger LOG = LoggerFactory.getLogger(SimpleGPUScheduler.class);
	 ...
	 */
	public SimpleGPUScheduler(ExecutorService executor) {
